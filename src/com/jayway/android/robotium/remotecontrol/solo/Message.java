...
public class Message extends org.safs.sockets.Message{
	...
	* this string's content format is: ";classname;classname;classname" */
	...
	public static final String PARAM_SCROLLPOSITION = "scrollposition";
	...
	public static final String PARAM_INCLUDSUBCLASSES = "includesubclasses";
	
	/** The Property key for a "turnon" parameter used by Solo. */
	public static final String PARAM_TURNON = "turnon";
	...
	/** "gettagforview" */
	public static final String cmd_gettagforview = "gettagforview";
	...
	/** "setmobiledata" */
	public static final String cmd_setmobiledata = "setmobiledata";
	
	/** "setwifidata" */
	public static final String cmd_setwifidata = "setwifidata";
	...
	public static final String cmd_waitforviewbytagreference = "waitforviewbytagreference";
	
	/** "waitforviewbytagreferencetimeout" waitForViewByTag(String, int, int)*/
	public static final String cmd_waitforviewbytagreferencetimeout = "waitforviewbytagreferencetimeout";
	
	/** "waitforviewbytagreferencetimeoutscroll" waitForViewByTag(String, int, int, boolean)*/
	public static final String cmd_waitforviewbytagreferencetimeoutscroll = "waitforviewbytagreferencetimeoutscroll";
	...
	* if scrolling should be performed */
	...
	public static final String cmd_getviewbytag = "getviewbytag";
	
	/** "getviewbytagmatch" getViewByTag(String , int )*/
	public static final String cmd_getviewbytagmatch = "getviewbytagmatch";
	...
	/**============================= Support for Robotium 5.1 Begin=============================================*/
	
	/** "getwebelements" getWebElements()*/
	public static final String cmd_getwebelements = "getwebelements";
	
	/** "getwebelementsby" getWebElements(By)*/
	public static final String cmd_getwebelementsby = "getwebelementsby";
	
	/** "presssoftkeyboardnextbutton"  pressSoftKeyboardNextButton() */
	public static final String cmd_presssoftkeyboardnextbutton = "presssoftkeyboardnextbutton";

	/** "presssoftkeyboardsearchbutton" pressSoftKeyboardSearchButton() */
	public static final String cmd_presssoftkeyboardsearchbutton = "presssoftkeyboardsearchbutton";

	/** "setnavigationdrawer" setNavigationDrawer(int) */
	public static final String cmd_setnavigationdrawer = "setnavigationdrawer";

	/** "waitforemptyactivitystack" waitForEmptyActivityStack(int)*/
	public static final String cmd_waitforemptyactivitystack = "waitforemptyactivitystack";
		
	/** "config_gettimeoutsmall" Config.timeout_small*/
	public static final String cmd_config_gettimeoutsmall = "config_gettimeoutsmall";
		
	/** "config_settimeoutsmall" Config.timeout_small*/
	public static final String cmd_config_settimeoutsmall = "config_settimeoutsmall";
		
	/** "config_gettimeoutlarge" Config.timeout_large*/
	public static final String cmd_config_gettimeoutlarge = "config_gettimeoutlarge";
		
	/** "config_settimeoutlarge" Config.timeout_large*/
	public static final String cmd_config_settimeoutlarge = "config_settimeoutlarge";
		
	/** "config_getshouldscroll" Config.shouldScroll*/
	public static final String cmd_config_getshouldscroll = "config_getshouldscroll";
		
	/** "config_setshouldscroll" Config.shouldScroll*/
	public static final String cmd_config_setshouldscroll = "config_setshouldscroll";
		
	/** "config_getusejavascripttoclickwebelements" Config.useJavaScriptToClickWebElement*/
	public static final String cmd_config_getusejavascripttoclickwebelements = "config_getusejavascripttoclickwebelements";

	/** "config_setusejavascripttoclickwebelements" Config.useJavaScriptToClickWebElement*/
	public static final String cmd_config_setusejavascripttoclickwebelements = "config_setusejavascripttoclickwebelements";

	/** "config_getscreenshotsavepath" Config.screenshotSavePath*/
	public static final String cmd_config_getscreenshotsavepath = "config_getscreenshotsavepath";
		
	/** "config_setscreenshotsavepath" Config.screenshotSavePath*/
	public static final String cmd_config_setscreenshotsavepath = "config_setscreenshotsavepath";
		
	/** "config_getscreenshotfiletype" Config.screenshotFileType*/
	public static final String cmd_config_getscreenshotfiletype = "config_getscreenshotfiletype";
		
	/** "config_setscreenshotfiletype" Config.screenshotFileType*/
	public static final String cmd_config_setscreenshotfiletype = "config_setscreenshotfiletype";
	...
	/**============================= Support for Robotium 5.1 End ==============================================*/
	
	/** "unlockscreen" unlockScreen() 5.2.1*/
	public static final String cmd_unlockscreen = "unlockscreen";
