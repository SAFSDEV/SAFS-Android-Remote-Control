 ...
 * so that it can be transported as an object thru our TCP protocol.
 * <p>
 ...
 * 
 * This class copy the content of com.robotium.solo.By, if that class is modified, we needs<br>
 * to update this class also.<br>
 * 
 * @author Lei Wang, SAS Institute, Inc
 * @since  May 14, 2013
 * <br>Update MAR 17, 2014 to support com.robotium.solo package.
 *
 */
public abstract class By implements Serializable{
	 ...
	 * 
	 * @return Object, an object of com.robotium.solo.By
	 */
	public Object toSoloBy(){
		try {
			Method method = Class.forName("com.robotium.solo.By").getMethod(getStaticMethodName(), String.class);
